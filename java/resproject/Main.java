		...
		while(loop) {
			...
			if(code == 1) {
				...
				if(result == 1) {
					...
					System.out.println("오류가 발생하여 로그인에 실패했습니다.");
				}
				...
				if (result == 1) {
					...
					System.out.println("오류가 발생하여 계정 생성에 실패했습니다.");
				}				
			...
			if (code == 1) {
				...
				try {
					...
					if (result == 1) {
						...
						System.out.println("오류가 발생하여 리뷰 입력에 실패했습니다.");
					}
				...
				try {
					...
					if (result == 1) {
						...
						System.out.println("오류가 발생하여 리뷰 수정에 실패했습니다.");
					}
